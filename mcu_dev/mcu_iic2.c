...
uint32_t sEE_TIMEOUT_UserCallback(void)
{
    jprintf("sEE_TIMEOUT_UserCallback");
    /* Block communication and all processes */
    while (1)
    {
    }
...
//        }
        ...
        {
            if((sEETimeout--) == 0){
                jprintf("faile at I2C_EVENT_MASTER_MODE_SELECT");
            }
        }
        ...
        /*!< Send EEPROM address for write */
        sEETimeout = sEE_FLAG_TIMEOUT;
        I2C_Send7bitAddress(sEE_I2C, 0x68, I2C_Direction_Transmitter);
    ...
    {
        jprintf(" Transfer 1 PASSED  ");
    }
    else
    {
        jprintf(" Transfer 1 FAILED  ");
    }
#endif /* ENABLE_LCD_MSG_DISPLAY */
    ...
    if (TransferStatus1 == PASSED)
    {
        jprintf(" Transfer 2 PASSED  ");
    }
    else
    {
        jprintf(" Transfer 2 FAILED  ");
    }
#endif /* ENABLE_LCD_MSG_DISPLAY */
